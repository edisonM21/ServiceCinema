...
public class InitialDataLoadRunner implements CommandLineRunner {
    ...
    private void createInitialGenres() {
        ...
        genreRepository.save(Genre
                .builder()
                .name("Drama")
                .description("Movie with a serious tone or theme")
                .build());

        genreRepository.save(Genre
                .builder()
                .name("Ficción")
                .description("imaginary or simulated worlds that the narrative arts construct")
                .build());
        genreRepository.save(Genre
                .builder()
                .name("Comedy")
                .description("Discourses or works intended to be humorous or amusing by inducing laughter")
                .build());
        genreRepository.save(Genre
                .builder()
                .name("Adventure")
                .description("It is a literary narrative genre that narrates travel, mystery and risk")
                .build());
    }
    ...
    private void createInitialMovies() {
        ...
        moviesRepository.save(Movie
                ...
                .backdropPath("")
                .posterPath("")
                .genres(List.of(genreList.get(0)))
                .video(false)
                .voteAverage(0.0D)
                .voteCount(0)
                .popularity(0.0)
        ...
        moviesRepository.save(Movie
                ...
                .backdropPath("")
                .posterPath("")
                .genres(List.of(genreList.get(3)))
                .video(false)
                .voteAverage(0.0D)
                .voteCount(0)
                .popularity(0.0)
        ...
        moviesRepository.save(Movie
                ...
                .backdropPath("")
                .posterPath("")
                .genres(List.of(genreList.get(2)))
                .video(false)
                .voteAverage(0.0D)
                .voteCount(0)
                .popularity(0.0)
        ...
        moviesRepository.save(Movie
                ...
                .backdropPath("")
                .posterPath("")
                .genres(List.of(genreList.get(4)))
                .video(false)
                .voteAverage(0.0D)
                .voteCount(0)
                .popularity(0.0)
        ...
        moviesRepository.save(Movie
                ...
                .backdropPath("")
                .posterPath("")
                .genres(List.of(genreList.get(5)))
                .video(false)
                .voteAverage(0.0D)
                .voteCount(0)
                .popularity(0.0)
